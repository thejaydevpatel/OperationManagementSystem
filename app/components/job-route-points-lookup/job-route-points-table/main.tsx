...
>
              ...
              <div className="flex justify-end mb-4">
                <Link
                  href={`/dashboard/job-route-points-lookup/job-route-points-table/list`}
                >
                  <Button
                    variant="outline"
    ...
    <div className="col-span-1">
      <div className="flex items-center gap-2">
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["location_id"]}
          onClick={() =>
            handleRefresh("location_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
