...
interface f_tablePaginationTableProps {
  rows: FTableEntity[];
  ...
  setList: React.Dispatch<React.SetStateAction<FTableEntity[]>>;
  customPage: number;
  customRowsPerPage: number;
  customSetPage: React.Dispatch<React.SetStateAction<number>>;
  customTotalRecordObj: Pagination;
  customSortBy: keyof FTableEntity;
  customSetSortBy: React.Dispatch<React.SetStateAction<keyof FTableEntity>>;
...
const List: React.FC<f_tablePaginationTableProps> = ({
  rows,
  onDelete,
  onStatus,
  onView,
...
const filteredRows = rows.filter((row) => {
  ...
  if (rows.length === 0 && !pageLoading) {
    return (
      <EmptyState
        title={`You haven't created any F Table yet`}
        description="Create your first record to get started."
        buttonText={`New F Table`}
       buttonHref="/dashboard/f-lookup/f-table/new"
  ...
  return (
    <>
      <div className="flex items-center justify-between mb-6">
                <Link
                  href="/dashboard/f-lookup/f-table/new"
                >
                            ...
                            <TableCell>
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  <DropdownMenuItem
                                        onClick={() => router.push(`/dashboard/f-lookup/f-table/${row.id}`)}                                  >
                                    Edit
                                  </DropdownMenuItem>
