...
export const getSharedGroupJobsTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<SharedGroupJobsTableEntity[]>> => {
        return await api.get<ApiResponse<SharedGroupJobsTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<SharedGroupJobsTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: SharedGroupJobsTableEntity
