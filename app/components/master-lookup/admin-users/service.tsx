...
export const getAdminUsersEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<AdminUsersEntity[]>> => {
        return await api.get<ApiResponse<AdminUsersEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<AdminUsersEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: AdminUsersEntity
