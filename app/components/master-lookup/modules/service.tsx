...
export const getModulesEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<ModulesEntity[]>> => {
        return await api.get<ApiResponse<ModulesEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<ModulesEntity>>(id);
      },
