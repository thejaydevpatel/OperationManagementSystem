...
export const getVehicleTypesTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<VehicleTypesTableEntity[]>> => {
        return await api.get<ApiResponse<VehicleTypesTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<VehicleTypesTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: VehicleTypesTableEntity
