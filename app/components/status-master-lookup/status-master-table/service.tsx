...
export const getStatusMasterTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<StatusMasterTableEntity[]>> => {
        return await api.get<ApiResponse<StatusMasterTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<StatusMasterTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: StatusMasterTableEntity
