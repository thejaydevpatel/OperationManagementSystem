...
export const getOperationLogsTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<OperationLogsTableEntity[]>> => {
        return await api.get<ApiResponse<OperationLogsTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<OperationLogsTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: OperationLogsTableEntity
