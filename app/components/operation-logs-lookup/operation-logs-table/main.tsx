...
>
              ...
              <div className="flex justify-end mb-4">
                <Link
                  href={`/dashboard/operation-logs-lookup/operation-logs-table/list`}
                >
                  <Button
                    variant="outline"
    ...
    <div className="col-span-1">
      <div className="flex items-center gap-2">
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["old_status_id"]}
          onClick={() =>
            handleRefresh("old_status_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
    ...
    <div className="col-span-1">
      <div className="flex items-center gap-2">
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["new_status_id"]}
          onClick={() =>
            handleRefresh("new_status_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
