...
export const getVehiclesTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<VehiclesTableEntity[]>> => {
        return await api.get<ApiResponse<VehiclesTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<VehiclesTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: VehiclesTableEntity
