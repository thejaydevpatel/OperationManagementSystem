...
>
              ...
              <div className="flex justify-end mb-4">
                <Link
                  href={`/dashboard/vehicles-lookup/vehicles-table/list`}
                >
                  <Button
                    variant="outline"
      ...
      <div className="flex items-center gap-2">
        <div className="flex-1">
          <RHFSelect
            ...
            control={control}
            errors={errors}
            options={vehicle_type_id.map((op) => {
              return {
                value: Number(op.id),
                label: op.name,
              };
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["vehicle_type_id"]}
          onClick={() =>
            handleRefresh("vehicle_type_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
      ...
      <div className="flex items-center gap-2">
        <div className="flex-1">
          <RHFSelect
            ...
            control={control}
            errors={errors}
            options={vehicle_status_id.map((op) => {
              return {
                value: Number(op.id),
                label: op.name,
              };
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["vehicle_status_id"]}
          onClick={() =>
            handleRefresh("vehicle_status_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
