...
interface a_tablePaginationTableProps {
  rows: ATableEntity[];
  ...
  setList: React.Dispatch<React.SetStateAction<ATableEntity[]>>;
  customPage: number;
  customRowsPerPage: number;
  customSetPage: React.Dispatch<React.SetStateAction<number>>;
  customTotalRecordObj: Pagination;
  customSortBy: keyof ATableEntity;
  customSetSortBy: React.Dispatch<React.SetStateAction<keyof ATableEntity>>;
...
const List: React.FC<a_tablePaginationTableProps> = ({
  rows,
  onDelete,
  onStatus,
  onView,
...
const filteredRows = rows.filter((row) => {
  ...
  if (rows.length === 0 && !pageLoading) {
    return (
      <EmptyState
        title={`You haven't created any A Table yet`}
        description="Create your first record to get started."
        buttonText={`New A Table`}
       buttonHref="/dashboard/a-lookup/a-table/new"
  ...
  return (
    <>
      <div className="flex items-center justify-between mb-6">
                <Link
                  href="/dashboard/a-lookup/a-table/new"
                >
                            ...
                            <TableCell>
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  <DropdownMenuItem
                                        onClick={() => router.push(`/dashboard/a-lookup/a-table/${row.id}`)}                                  >
                                    Edit
                                  </DropdownMenuItem>
