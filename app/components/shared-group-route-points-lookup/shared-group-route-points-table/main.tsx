...
>
              ...
              <div className="flex justify-end mb-4">
                <Link
                  href={`/dashboard/shared-group-route-points-lookup/shared-group-route-points-table/list`}
                >
                  <Button
                    variant="outline"
    ...
    <div className="col-span-1">
      <div className="flex items-center gap-2">
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["group_id"]}
          onClick={() =>
            handleRefresh("group_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
    ...
    <div className="col-span-1">
      <div className="flex items-center gap-2">
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["locarion_id"]}
          onClick={() =>
            handleRefresh("locarion_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
