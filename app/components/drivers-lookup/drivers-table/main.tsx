...
>
              ...
              <div className="flex justify-end mb-4">
                <Link
                  href={`/dashboard/drivers-lookup/drivers-table/list`}
                >
                  <Button
                    variant="outline"
      ...
      <div className="flex items-center gap-2">
        <div className="flex-1">
          <RHFSelect
            ...
            label="Driver Status Id"
            control={control}
            errors={errors}
            options={driver_status_id.map((op) => {
              return {
                value: Number(op.id),
                label: op.name,
              };
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["driver_status_id"]}
          onClick={() =>
            handleRefresh("driver_status_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
      ...
      <div className="flex items-center gap-2">
        <div className="flex-1">
          <RHFSelect
            ...
            label="Last Known Location Id"
            control={control}
            errors={errors}
            options={last_known_location_id.map((op) => {
              return {
                value: Number(op.id),
                label: op.name,
              };
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["last_known_location_id"]}
          onClick={() =>
            handleRefresh("last_known_location_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
    ...
    <div className="col-span-1">
      <div className="flex items-center">
        <div className="flex-1">
          <RHFTimePicker
            control={control}
            name="last_duty_end_time"
            label="Last Duty End Time"
          />
        </div>
        {/*<LabelWithTooltip
          text=""
