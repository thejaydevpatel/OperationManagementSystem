...
export const getDriversTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<DriversTableEntity[]>> => {
        return await api.get<ApiResponse<DriversTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<DriversTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: DriversTableEntity
