...
export const getGuideLanguagePriceEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<GuideLanguagePriceEntity[]>> => {
        return await api.get<ApiResponse<GuideLanguagePriceEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<GuideLanguagePriceEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: GuideLanguagePriceEntity
