...
export const getGuideAllocationTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<GuideAllocationTableEntity[]>> => {
        return await api.get<ApiResponse<GuideAllocationTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<GuideAllocationTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: GuideAllocationTableEntity
