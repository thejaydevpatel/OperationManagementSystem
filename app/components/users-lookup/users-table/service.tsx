...
export const getUsersTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<UsersTableEntity[]>> => {
        return await api.get<ApiResponse<UsersTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<UsersTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: UsersTableEntity
