...
>
              ...
              <div className="flex justify-end mb-4">
                <Link
                  href={`/dashboard/driver-allocation-lookup/driver-allocation-table/list`}
                >
                  <Button
                    variant="outline"
    ...
    <div className="col-span-1">
      <div className="flex items-center gap-2">
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["vehicle_id"]}
          onClick={() =>
            handleRefresh("vehicle_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
      ...
      <div className="flex items-center gap-2">
        <div className="flex-1">
          <RHFSelect
            ...
            label="Allocation Status Id"
            control={control}
            errors={errors}
            options={allocation_status_id.map((op) => {
              return {
                value: Number(op.id),
                label: op.name,
              };
        ...
        {/*<SpinningRefreshIcon
          spinning={dropDownloading["allocation_status_id"]}
          onClick={() =>
            handleRefresh("allocation_status_id", handleDropDown)
          }
        />*/}
        {/*<LabelWithTooltip
          text=""
