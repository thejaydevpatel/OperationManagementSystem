...
export const getDriverAllocationTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<DriverAllocationTableEntity[]>> => {
        return await api.get<ApiResponse<DriverAllocationTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<DriverAllocationTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: DriverAllocationTableEntity
