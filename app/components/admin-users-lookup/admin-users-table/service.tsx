...
export const getAdminUsersTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<AdminUsersTableEntity[]>> => {
        return await api.get<ApiResponse<AdminUsersTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<AdminUsersTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: AdminUsersTableEntity
