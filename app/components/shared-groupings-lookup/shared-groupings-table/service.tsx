...
export const getSharedGroupingsTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<SharedGroupingsTableEntity[]>> => {
        return await api.get<ApiResponse<SharedGroupingsTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<SharedGroupingsTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: SharedGroupingsTableEntity
