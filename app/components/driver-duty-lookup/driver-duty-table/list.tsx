...
interface driver_duty_tablePaginationTableProps {
  rows: DriverDutyTableEntity[];
  onDelete: (Id: number) => void;
  onStatus: (Id: number) => void;
  onView: (Id: number) => void;
  onListToggle: () => void;
  module: ModuleDetailsString;
  setList: React.Dispatch<React.SetStateAction<DriverDutyTableEntity[]>>;
  customPage: number;
  customRowsPerPage: number;
  customSetPage: React.Dispatch<React.SetStateAction<number>>;
  customTotalRecordObj: Pagination;
  customSortBy: keyof DriverDutyTableEntity;
  customSetSortBy: React.Dispatch<React.SetStateAction<keyof DriverDutyTableEntity>>;
...
const List: React.FC<driver_duty_tablePaginationTableProps> = ({
  rows,
  onDelete,
  onStatus,
  onView,
...
const filteredRows = rows.filter((row) => {
  ...
  if (rows.length === 0 && !pageLoading) {
    return (
      <EmptyState
        title={`You haven't created any Driver Duty Table yet`}
        description="Create your first record to get started."
        buttonText={`New Driver Duty Table`}
       buttonHref="/dashboard/driver-duty-lookup/driver-duty-table/new"
  ...
  return (
    <>
      <div className="flex items-center justify-between mb-6">
                <Link
                  href="/dashboard/driver-duty-lookup/driver-duty-table/new"
                >
...
<TableHead>Duty Start Time</TableHead>
<TableHead>Duty End Time</TableHead>
                            ...
                            <TableCell>
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  <DropdownMenuItem
                                        onClick={() => router.push(`/dashboard/driver-duty-lookup/driver-duty-table/${row.id}`)}                                  >
                                    Edit
                                  </DropdownMenuItem>
