...
export const getDriverDutyTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<DriverDutyTableEntity[]>> => {
        return await api.get<ApiResponse<DriverDutyTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<DriverDutyTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: DriverDutyTableEntity
