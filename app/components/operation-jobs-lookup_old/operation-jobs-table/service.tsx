...
export const getOperationJobsTableEntityApi = (module: ModuleDetailsString) => {
  const api = HttpService(module.endPoint);
   ...
   return {
      ...
      fetchAll: async (
        query: string = ""
      ): Promise<ApiResponse<OperationJobsTableEntity[]>> => {
        return await api.get<ApiResponse<OperationJobsTableEntity[]>>(query);
      },
      ...
      fetchById: async (
        ...
        return await api.getById<ApiResponse<OperationJobsTableEntity>>(id);
      },
  
      // CREATE
      create: async (
        data: OperationJobsTableEntity
