...
export async function GET(req: NextRequest) {
  ...
  const { searchParams } = new URL(req.url);
    ...
    const allowedSortFields = ["is_used","is_deleted","is_active","created_at","updated_at","created_by","updated_by","host_ip","url","deleted_at","deleted_by","tenant_id","id","name","phone","license_number","supplier_id","driver_status_id","last_known_location_id","last_duty_end_time","max_daily_hours","note"]; // adjust to your table columns
