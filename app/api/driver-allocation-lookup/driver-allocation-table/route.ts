...
export async function GET(req: NextRequest) {
  ...
  const { searchParams } = new URL(req.url);
    ...
    const allowedSortFields = ["is_used","is_deleted","is_active","created_at","updated_at","created_by","updated_by","host_ip","url","deleted_at","deleted_by","tenant_id","id","job_id","driver_id","vehicle_id","allocation_status_id","supplier_id","start_time","end_time","manual_cost","notes"]; // adjust to your table columns
