...
export async function GET(req: NextRequest) {
  ...
  const { searchParams } = new URL(req.url);
    ...
    const allowedSortFields = ["is_used","is_deleted","is_active","created_at","updated_at","created_by","updated_by","host_ip","url","deleted_at","deleted_by","tenant_id","id","name","vehicle_type_id","registration_number","owner_type","supplier_id","vehicle_status_id","additional_notes"]; // adjust to your table columns
